export const fakeApiRes = {
  ...
  industryIdentifiers: [
    { type: 'ISBN_13', identifier: '9780299326104' },
    { type: 'ISBN_10', identifier: '0299326101' },
  ],
  ...
  imageLinks: {
    smallThumbnail:
      'http://books.google.com/books/content?id=2lLWDwAAQBAJ&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api',
    thumbnail:
      'http://books.google.com/books/content?id=2lLWDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
  },
  language: 'en',
  previewLink:
    'http://books.google.co.th/books?id=2lLWDwAAQBAJ&printsec=frontcover&dq=isbn:0299326101&hl=&cd=1&source=gbs_api',
  infoLink:
    'http://books.google.co.th/books?id=2lLWDwAAQBAJ&dq=isbn:0299326101&hl=&source=gbs_api',
  canonicalVolumeLink:
    'https://books.google.com/books/about/Rise_of_the_Brao.html?hl=&id=2lLWDwAAQBAJ',
};
